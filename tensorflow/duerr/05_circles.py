...
X, Y = sklearn.datasets.make_circles(n_samples=100, random_state=0, noise=0.1, factor=0.5)
...
plt.savefig("IMG_05_circles.pdf")
...
plt.savefig("IMG_05_decision_boundary.pdf")
