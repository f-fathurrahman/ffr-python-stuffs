...
%\newminted{ipython}{breaklines,fontsize=\footnotesize,texcomments=true}
\newminted{pycon}{breaklines,fontsize=\footnotesize,texcomments=true}
...
\BeforeBeginEnvironment{minted}{\begin{mdframed}[backgroundcolor=mintedbg,hidealllines=true]}
