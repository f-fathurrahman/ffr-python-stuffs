...
from my_torchani.units import hartree2kcalmol
...
try:
    ...
    path = os.getcwd()
dspath = os.path.join(path, '/home/efefer/WORKS/TORCHANI/torchani-master/dataset/ani1-up_to_gdb4/ani_gdb_s01.h5')
batch_size = 2560
...
nn = my_torchani.ANIModel([H_network, C_network, N_network, O_network])
print(nn)
...
model = my_torchani.nn.Sequential(aev_computer, nn).to(device)
