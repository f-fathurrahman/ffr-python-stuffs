...
atoms_data["N"] ={"Z":7, "symbol":"N", "name":"nitrogen", "mass":14.0067,  "R_cov":0.71,"R_vdw":1.55,"IE":14.527,"EA":0.072}

atoms_data["O"] ={"Z":8, "symbol":"O", "name":"oxygen",   "mass":15.9994,  "R_cov":0.66,"R_vdw":1.52,"IE":13.612,"EA":1.460}

atoms_data["F"] ={"Z":9, "symbol":"F"}

atoms_data["Ne"]={"Z":10,"symbol":"Ne"}

atoms_data["Na"]={"Z":11,"symbol":"Na","name":"sodium",   "mass":22.9898,  "R_cov":1.66,"R_vdw":2.27,"IE":5.136, "EA":0.547}

atoms_data["Mg"]={"Z":12,"symbol":"Mg","name":"magnesium","mass":24.3050,  "R_cov":1.41,"R_vdw":1.73,"IE":7.642, "EA":0.000}

atoms_data["Si"]={"Z":14,"symbol":"Si","name":"silicon",  "mass":28.0855}

atoms_data["P"] ={"Z":15,"symbol":"P", "name":"phosphorus","mass":30.9737, "R_cov":1.07,"R_vdw":1.80,"IE":10.487, "EA":0.746}

atoms_data["S"] ={"Z":16, "symbol":"S", "name":"sulfur",  "mass":32.065,   "R_cov":1.05,"R_vdw":1.80,"IE":10.356, "EA":2.072}

atoms_data["Cl"]={"Z":17,"symbol":"Cl","name":"chlorine", "mass":35.4530,  "R_cov":1.02,"R_vdw":1.75,"IE":12.962,"EA":3.615}

atoms_data["Ar"]={"Z":18,"symbol":"Ar"}

atoms_data["K"] ={"Z":19,"symbol":"K", "name":"potassium","mass":39.0983,  "R_cov":2.03,"R_vdw":2.75,"IE":4.338, "EA":0.501}
...
atoms_data["Kr"]={"Z":36,"symbol":"Kr"}

atoms_data["Sr"]={"Z":38,"symbol":"Sr","name":"strontium","mass":87.62,    "R_cov":1.95,"R_vdw":2.49, "IE":5.69,"EA":0.052}

atoms_data["Mo"]={"Z":42,"symbol":"Mo","name":"molybdenum","mass":95.94,   "R_cov":1.57,"R_vdw":2.10, "IE":7.08,"EA":0.744}

atoms_data["Pd"]={"Z":46,"symbol":"Pd"}

atoms_data["Sn"]={"Z":50, "symbol":"Sn", "R_cov":1.39}

atoms_data["Xe"]={"Z":54,"symbol":"Xe"}

atoms_data["Pt"]={"Z":78,"symbol":"Pt","name":"platinum", "mass":195.084,  "R_cov":1.36,"R_vdw":1.75,"IE":9.013, "EA":2.127}

atoms_data["Au"]={"Z":79,"symbol":"Au","name":"gold",     "mass":196.9666, "R_cov":1.36,"R_vdw":1.66,"IE":9.221, "EA":2.308}
...
for key in valence_orbitals:
    atoms_data[key]["valence_orbitals"]=valence_orbitals[key]
...
for key in configurations:
    ...
    atoms_data[key]["configuration"]=config
    atoms_data[key]["valence_number"]=sum( [config[orbital] for orbital in atoms_data[key]["valence_orbitals"]] )
