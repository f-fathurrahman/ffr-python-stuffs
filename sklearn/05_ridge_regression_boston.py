...
# mean-squred error
mse = metrics.mean_squared_error(y_train, ridgereg.predict(X_train))
print('mse on training data = %18.10f' % mse)

# r2 scoring from ridgereg
...
plt.savefig('05_truth_vs_predicted.png', dpi=300)
...
plt.savefig('05_truth_vs_predicted_v2.png', dpi=300)