...
a = [fit("LOG_Al-ecut-%d.txt" % ecut) for ecut in cutoffs]
...
plt.grid()
plt.savefig("Al_conv_ecut.png", dpi=200)

#kpoints = range(4, 17)
#plt.figure(figsize=(6, 4))
#a = [fit("LOG_Al-kpt-%02d.txt" % k) for k in kpoints]
#plt.plot(kpoints, a, "-")
#plt.xlabel("number of k-points")
#plt.ylabel("lattice constant [Ang]")
#plt.grid()
#plt.savefig("Al_conv_k.png", dpi=200)
